...
if(isset($_GET['decision']))
{
    if($_GET['decision']=='selected')
    {
        ...
        $query=mysqli_query($conn,"UPDATE interns SET decision=1 WHERE id=".$_GET['id']);
    }
    if($_GET['decision']=='rejected')
    {
        $message='You have been rejected';
        $query=mysqli_query($conn,"UPDATE interns SET decision=0 WHERE id=".$_GET['id']);
    }
...
<body>
        ...
        <div id="content">
            ...
            <nav class="navbar  navbar-light " style="background-color: rgb(255, 255, 128); ">
                <div class="container-fluid">
                    ...
                    <div class="dropdown " style="margin-right:40px">
                        <button class="btn btn-danger dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"  >
                           <img src="https://img.icons8.com/ios-filled/20/000000/gender-neutral-user.png"/> <span style="padding-right:20px"> Admin Logout</span>   
                        </button>
            ...
            <!-- start: BASIC EXAMPLE -->
                    ...
                    <?php echo htmlentities($_SESSION['msg']="");?></p>	
                        <table class="table table-hover" id="sample-table-1">
                           ...
                           <tbody>
                                       <?php
                                       $sql=mysqli_query($conn,"select * from interns");
                                        $cnt=1;
                                ...
                                <tr>
                                    ...
                                    <td><a href='<?php echo "/new/upload/".$row['resume']; ?>' download onClick=""class="btn btn-transparent btn-xs tooltips"
                                     tooltip-placement="top" tooltip="Remove">
                                     <img src="img/download.png"></a></td>
                                    <td>
                                    <div class="visible-md visible-lg hidden-sm hidden-xs">
                
                                    <a href="manage.php?decision=selected&id=<?php echo $row['id'];?>" 
                                    onClick="return confirm('Select')"class="btn btn-transparent btn-xs tooltips"
                                     tooltip-placement="top" tooltip="Remove">
                                     <img src="img/select.png"></a>
                                    </div>
                                        </td>
                                        <td>
                                        <div class="visible-md visible-lg hidden-sm hidden-xs">  
                                    <a href="manage.php?decision=rejected&id=<?php echo $row['id'];?>" 
                                    onClick="return confirm('Reject')"class="btn btn-transparent btn-xs tooltips"
                                     tooltip-placement="top" tooltip="Remove">
                                    <img src="img/reject.png"></a>
                                      </div>
                                        </td>
                                </tr>
